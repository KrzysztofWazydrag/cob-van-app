...
const sources = {
  ...
  'coronation-chicken-sandwich': require('../../assets/coronation-chicken-sandwich.png'),
  'ham-cheese-toastie': require('../../assets/ham-cheese-toastie.png'),
  'tuna-mayo-cob': require('../../assets/tuna-mayo-cob.png'),
